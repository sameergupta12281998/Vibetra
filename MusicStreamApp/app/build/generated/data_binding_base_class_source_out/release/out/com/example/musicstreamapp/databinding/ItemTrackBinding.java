...
public final class ItemTrackBinding implements ViewBinding {
  ...
  private ItemTrackBinding(@NonNull LinearLayout rootView, @NonNull ImageButton btnAddToPlaylist,
      @NonNull ImageButton btnFavorite, @NonNull ImageView ivThumbnail,
  ...
  public static ItemTrackBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ItemTrackBinding((LinearLayout) rootView, btnAddToPlaylist, btnFavorite,
          ivThumbnail, tvTrackArtist, tvTrackDuration, tvTrackTitle);
    }
