package com.example.musicstreamapp.data.db;
...
import com.example.musicstreamapp.data.db.dao.FavoritesDao;
import com.example.musicstreamapp.data.db.dao.FavoritesDao_Impl;
import com.example.musicstreamapp.data.db.dao.PlaylistDao;
import com.example.musicstreamapp.data.db.dao.PlaylistDao_Impl;
    ...
    final SupportSQLiteOpenHelper.Callback _openCallback = new RoomOpenHelper(config, new RoomOpenHelper.Delegate(1) {
      ...
      public RoomOpenHelper.ValidationResult onValidateSchema(
        ...
        if (!_infoFavoriteTracks.equals(_existingFavoriteTracks)) {
          return new RoomOpenHelper.ValidationResult(false, "favorite_tracks(com.example.musicstreamapp.data.db.entity.FavoriteTrackEntity).\n"
                  + " Expected:\n" + _infoFavoriteTracks + "\n"
        ...
        if (!_infoPlaylists.equals(_existingPlaylists)) {
          return new RoomOpenHelper.ValidationResult(false, "playlists(com.example.musicstreamapp.data.db.entity.PlaylistEntity).\n"
                  + " Expected:\n" + _infoPlaylists + "\n"
                  + " Found:\n" + _existingPlaylists);
        }
        ...
        if (!_infoPlaylistTracks.equals(_existingPlaylistTracks)) {
          return new RoomOpenHelper.ValidationResult(false, "playlist_tracks(com.example.musicstreamapp.data.db.entity.PlaylistTrackEntity).\n"
                  + " Expected:\n" + _infoPlaylistTracks + "\n"
